...
INSERT INTO "gift_message" VALUES(2006,'Reward for ranking {2} in the {0} Clan Battle''s {1} period rankings.',10,11,7,0);
...
INSERT INTO "gift_message" VALUES(3002,'Item obtaind for unlocking the 3rd floor of the Guild House.',0,0,0,0);
...
INSERT INTO "gift_message" VALUES(9213,'Present for the Guild House from the operations team.',0,0,0,0);
INSERT INTO "gift_message" VALUES(9214,'「公式生放送　2018　秋」内コーナーの特別プレゼントです。',0,0,0,0);
INSERT INTO "gift_message" VALUES(9215,'Present for the update of the Luna Tower.',0,0,0,0);
...
INSERT INTO "gift_message" VALUES(9313,'Character exchange rewards obtained when the possession limit is exceeded.',0,0,0,0);
INSERT INTO "gift_message" VALUES(9314,'Item converted from Character Exchange Pts when the Gacha updated.',0,0,0,0);
...
INSERT INTO "gift_message" VALUES(9700,'「ロボリマ来襲！」で獲得したランキング報酬です。',0,0,0,0);
INSERT INTO "gift_message" VALUES(9701,'「ロボリマ来襲！」で獲得したアタック報酬です。',0,0,0,0);
COMMIT;